    ...
    <div id="wrapper">
          ...
          <li>
            ...
            <ul class="second_menu">
              ...
              <li>
                <a href="#">卷面成绩</a>
                <ul class="third_menu">
                  <li id="chosenPage"><a href="studentFinalExamScore.html">查看卷面成绩</a></li>
      ...
      <div id="content">
        <div id="selectCourse" class="middle">
          ...
          <input id="btnConfirmFinalExamScore" type="button" class="button" value="确定" >
        </div><!-- /search -->

        <div id="stuFinalExamScore" class="middle">
          <div>
              <input type="text" class="inputText" placeholder="学生学号">
              <input type="text" class="inputText" placeholder="学生姓名">
              <input id="btnSelectStuFinalExamScore" type="button" class="button" value="查询">
              <input id="btnRefreshFinalExamScore" type="button" class="button" value="刷新">
          </div>
