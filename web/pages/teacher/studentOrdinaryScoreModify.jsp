    ...
    <div id="wrapper">
      ...
      <div id="content">
            <table class="table">
                ...
                <tr>
                    <td class="sheet1">回答问题</td>
                    <td class="sheet2" id="stuAnswer"><input type="text" value="1"></td>
                    <td class="sheet1">作业</td>
                    <td class="sheet2" id="stuHomework"><input type="text" value="2/3"></td>
                </tr>
            </table>
            <div id="buttons" class="middle">
                <button id="confirmModifyOrdinaryScore" class="button confirmModify">确认修改</button>
                <button id="cancelModifyOrdinaryScore" class="button cancelModify">取消修改</button>
            </div>
      </div>
    </div><!-- /wrapper -->
