    ...
    <div id="wrapper">
      ...
      <div id="content">
            <table class="table">
                ...
                <tr>
                    <td class="sheet1">期中成绩</td>
                    <td class="sheet2" id="stuMidTest"><input type="text" value="80"></td>
                </tr>
            </table>
            <div id="buttons" class="middle">
                <button id="confirmModifyMidTestScore" class="button confirmModify">确认修改</button>
                <button id="cancelModifyMidTestScore" class="button cancelModify">取消修改</button>
            </div>
      </div>
    </div><!-- /wrapper -->
