    ...
    <div id="wrapper">
          ...
          <li>
            ...
            <ul class="second_menu">
              ...
              <li>
                <a href="#">平时成绩</a>
                <ul class="third_menu">
                  <li id="chosenPage"><a href="studentOrdinaryScore.html">查看平时成绩</a></li>
      ...
      <div id="content">
        <div id="selectCourse" class="middle">
          ...
          <input id="btnConfirmOrdinaryScore" type="button" class="button" value="确定" >
        </div><!-- /search -->

        <div id="stuOrdinaryScore" class="middle">
          <div>
              <input type="text" class="inputText" placeholder="学生学号">
              <input type="text" class="inputText" placeholder="学生姓名">
              <input id="btnSelectStuOrdinaryScore" type="button" class="button" value="查询">
              <input id="btnRefreshOrdinaryScore" type="button" class="button" value="刷新">
          </div>
