    ...
    <div id="wrapper">
      <div id="menu">
        <ul class="first_menu">
          ...
          <li>
            <a href="#">成绩统计表</a>
            <ul class="second_menu">
              <li id="chosenPage"><a href="studentTotalScore.html">查看总成绩</a></li>
            </ul><!-- /二级菜单 -->
          </li><!-- /成绩统计表li -->
      ...
      <div id="content">
        <div id="selectCourse" class="middle">
          ...
          <input id="btnConfirmTotalScore" type="button" class="button" value="确定" >
        </div><!-- /search -->

        <div id="stuTotalScore" class="middle">
          <div>
              <input type="text" class="inputText" placeholder="学生学号">
              <input type="text" class="inputText" placeholder="学生姓名">
              <input id="btnSelectStuTotalScore" type="button" class="button" value="查询">
              <input id="btnRefreshTotalScore" type="button" class="button" value="刷新">
              <input id="btnExportTotalScore" type="button" class="button exportScore" value="导出成绩表">
