              ...
              <ul class="second_menu">
                ...
                <li>
                  ...
                  <ul class="third_menu">
                    ...
                    <li id="chosenPage"><a href="importStudentOrdinaryScore.html">导入平时成绩</a></li>
                  </ul><!-- /三级菜单 -->
                </li>
      ...
      <div id="content">
        <div id="importStudent">
          ...
          <div id="import">
            ...
            <input type="button" id="btnConfirmOrdinaryScore" class="button" value="导入">
            <p class="remind">提示：请选择内容为<strong>平时成绩</strong>的Excel表格</p>
          </div>
          <div id="example">
            <p class="remind">Excel表格格式如下：</p>
            <img src="../../resources/image/平时成绩导入格式.png" width="700px">
          </div>
