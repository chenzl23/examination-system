    ...
    <div id="wrapper">
          ...
          <li>
            ...
            <ul class="second_menu">
              ...
              <li>
                <a href="#">实验成绩</a>
                <ul class="third_menu">
                  <li id="chosenPage"><a href="studentExperimentScore.html">查看实验成绩</a></li>  
      ...
      <div id="content">
        <div id="selectCourse" class="middle">
          ...
          <input id="btnConfirmExperimentScore" type="button" class="button" value="确定" >
        </div><!-- /search -->

        <div id="stuExperimentScore" class="middle">
          <div>
              <input type="text" class="inputText" placeholder="学生学号">
              <input type="text" class="inputText" placeholder="学生姓名">
              <input id="btnSelectStuExperimentScore" type="button" class="button" value="查询">
              <input id="btnRefreshExperimentScore" type="button" class="button" value="刷新">
          </div>
