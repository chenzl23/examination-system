    ...
    <div id="wrapper">
      ...
      <div id="content">
            <table class="table">
                ...
                <tr>
                    <td class="sheet1">期末成绩</td>
                    <td class="sheet2" id="stuFinalExam"><input type="text" value="80"></td>
                </tr>
            </table>
            <div id="buttons" class="middle">
                <button id="confirmModifyFinalExamScore" class="button confirmModify">确认修改</button>
                <button id="cancelModifyFinalExamScore" class="button cancelModify">取消修改</button>
            </div>
      </div>
    </div><!-- /wrapper -->
