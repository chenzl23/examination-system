...
public class StuinfoDao {
    Connection connStu=DBUtil.getConnection();
    /************添加学生*************/
    public void addStuinfo(Stuinfo s)throws SQLException{//通过PreparedStatement执行动态SQL语句
    ...
    //
    /************修改学生信息*************/
    public void updateStuinfo(Stuinfo s)throws SQLException{
